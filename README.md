...
This is an algorithm-based project in C Programming Language, by **Cynthia Wangari** and **Amutsa Tossy**. Several sorting algorithms are implemented, as well as their corresponding Big O notations.
